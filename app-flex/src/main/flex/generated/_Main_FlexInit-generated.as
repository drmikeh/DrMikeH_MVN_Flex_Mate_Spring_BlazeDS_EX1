...
<services>
	...
	<channels>
		<channel id="my-polling-amf" type="mx.messaging.channels.AMFChannel">
			<endpoint uri="http://localhost:8080/ex1/messagebroker/amfpolling"/>
			<properties>
		...
		<channel id="my-amf" type="mx.messaging.channels.AMFChannel">
			<endpoint uri="http://localhost:8080/ex1/messagebroker/amf"/>
			<properties>
			</properties>
		</channel>
	</channels>
